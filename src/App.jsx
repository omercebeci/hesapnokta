...
const DaireTadilatPlanlayici = lazy(() => import('./pages/calculators/insaat-tadilat/DaireTadilatPlanlayici.jsx'));
      ...
      <main>
        <Suspense fallback={null}>
          <Routes>
            ...
            <Route path="/daire-tadilat-planlayici" element={<DaireTadilatPlanlayici />} />
