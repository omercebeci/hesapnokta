...
const ITEMS = [
  ...
  { key: 'seramik', label: 'Seramik (malzeme + işçilik)', defaultAmount: '12000' },
  ...
  return (
    <CalculatorLayout calculatorId="banyo-tadilat-butcesi-hesaplama">
      ...
      <div className="info-card">
        ...
        <p>Genellikle sıra yıkım → tesisat/elektrik → seramik → vitrifiye/duşakabin → mobilya → boya şeklindedir. Kalemleri açıp kapatarak yalnızca yaptırmayı planladığınız işleri bütçeye dahil edebilir, birden fazla ustadan/firmadan aldığınız teklifleri karşılaştırarak buraya girebilirsiniz.</p>
      </div>
    </CalculatorLayout>
  );
}
